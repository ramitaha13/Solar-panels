  ...
  return (
    <>
      ...
      >
            ...
            <div className="flex flex-col h-full">
              ...
              <nav className="flex flex-col p-6 space-y-2">
                <a
                  href="#products"
                  onClick={(e) => handleNavClick(e, "#products")}
                  className="text-xl text-gray-700 hover:text-emerald-700 hover:bg-emerald-50 px-4 py-3 rounded-lg transition-all"
                >
                  מוצרים
                </a>
                <a
        ...
        {/* Hero Section */}
        <section className="relative bg-gradient-to-bl from-emerald-700 via-emerald-800 to-emerald-900 text-white overflow-hidden w-screen min-h-screen flex items-center">
          ...
          <div className="w-full px-6 py-32 relative z-10">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-lg md:text-2xl text-emerald-100 mb-12 leading-relaxed">
        ...
        <section
          id="products"
          className="py-20 bg-gradient-to-b from-stone-50 to-white w-screen"
        >
          <div className="w-full px-6">
            <div className="text-center mb-16">
              ...
              <p className="text-lg md:text-xl text-gray-600 max-w-2xl mx-auto">
                בחרו מתוך מגוון הפאנלים הסולאריים האיכותיים שלנו, המתאימים
                באחריות המובילה בתעשייה.
              </p>
            </div>
              ...
              {solarPanels.map((panel, index) => (
                <div
                  ...
                  className={`group relative bg-white rounded-3xl overflow-hidden transition-all duration-500 hover:shadow-2xl ${
                    panel.highlighted
                      ? "ring-4 ring-amber-400 md:scale-105 shadow-xl"
                      : "shadow-lg md:hover:scale-105"
                  }`}
                >
                  {panel.highlighted && (
        ...
        <section
          id="calculator"
          className="py-20 bg-gradient-to-br from-emerald-50 to-amber-50 w-screen"
        >
          <div className="w-full px-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
              {benefits.map((benefit, index) => {
                ...
                return (
                  <div
                    key={index}
                    className="group bg-gradient-to-br from-white to-emerald-50 p-8 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 md:hover:-translate-y-2 border border-emerald-100"
                  >
        ...
        <footer
          id="contact"
          className="bg-gradient-to-br from-emerald-900 to-emerald-950 text-white py-16 w-screen"
        >
          <div className="w-full px-6">
